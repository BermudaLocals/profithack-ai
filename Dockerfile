...
RUN npm install vite@5 esbuild @vitejs/plugin-react react react-dom @tanstack/react-query wouter drizzle-orm drizzle-zod zod express tailwindcss postcss autoprefixer --save --legacy-peer-deps
